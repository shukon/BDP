...
class ChatScreenState extends State<ChatScreen> {
  ...
  static const platform = const EventChannel(
      "com.bdp.bdp_app/message-received");

  Future<void> _getMessages() async {
    await platform.receiveBroadcastStream().listen((dynamic event) {
      print(event);
      var message = jsonDecode(event);
      _messages.insert(0,
          new ChatMessage(message["senderName"], text: message["text"]));
